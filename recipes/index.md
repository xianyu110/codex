...
| 15 | [Codex × Hatch Pet：用一张照片生成专属宠物](./hatch-pet-photo.md) | 生成并安装自定义桌面宠物 | 桌面 App / Hatch Pet | 素材质量、生成进度、宠物包路径 |
| 16 | [Codex × 安卓手机：扫码连接，远程操控](./android-remote-control.md) | 手机端配对并管理桌面任务 | ChatGPT App / Desktop App | 账号一致、网络、防火墙、连接状态 |
...
- 想优化桌面工作台体验：先看 [Hatch Pet](./hatch-pet-photo.md)，了解如何生成和安装自定义宠物。
...
### 02 Codex × Draw.io MCP：AI 自动绘制架构图

![Codex × Draw.io MCP：AI 自动绘制架构图 场景图](../assets/recipes/drawio-mcp.svg)

- 入口：[Codex × Draw.io MCP：AI 自动绘制架构图](drawio-mcp.md)

### 03 Codex × Playwright MCP：让 AI 像人一样操控浏览器

![Codex × Playwright MCP：让 AI 像人一样操控浏览器 场景图](../assets/recipes/playwright-mcp.svg)

- 入口：[Codex × Playwright MCP：让 AI 像人一样操控浏览器](playwright-mcp.md)

### 04 Codex × HyperFrames：用代码生成动画视频
...
### 08 Codex × Figma MCP：让 AI 读懂你的设计稿

![Codex × Figma MCP：让 AI 读懂你的设计稿 场景图](../assets/recipes/figma-mcp-codex.svg)

- 入口：[Codex × Figma MCP：让 AI 读懂你的设计稿](figma-mcp-codex.md)

### 09 Codex × Notion MCP：打通你的知识工作空间

![Codex × Notion MCP：打通你的知识工作空间 场景图](../assets/recipes/notion-mcp-codex.svg)

- 入口：[Codex × Notion MCP：打通你的知识工作空间](notion-mcp-codex.md)

### 10 Codex × DKFile：AI 网页一键发布到公网

![Codex × DKFile：AI 网页一键发布到公网 场景图](../assets/recipes/dkfile-deploy-codex.svg)

- 入口：[Codex × DKFile：AI 网页一键发布到公网](dkfile-deploy-codex.md)

### 11 Codex × 云服务器：远程定位并修复 Bug

![Codex × 云服务器：远程定位并修复 Bug 场景图](../assets/recipes/remote-bug-fix.svg)

- 入口：[Codex × 云服务器：远程定位并修复 Bug](remote-bug-fix.md)

### 12 Codex × Chrome：让 AI 直接控制浏览器
...
### 13 Codex × GitHub Actions：CI 失败自动修复实测

![Codex × GitHub Actions：CI 失败自动修复实测 场景图](../assets/recipes/github-actions-ci-fix.svg)

- 入口：[Codex × GitHub Actions：CI 失败自动修复实测](github-actions-ci-fix.md)

### 14 Codex × 临床文献综述：把医学问题整理成可复核证据表

![Codex × 临床文献综述：把医学问题整理成可复核证据表 场景图](../assets/recipes/clinical-literature-review.svg)

- 入口：[Codex × 临床文献综述：把医学问题整理成可复核证据表](clinical-literature-review.md)

### 15 Codex × Hatch Pet：用一张照片生成专属宠物

![Codex × Hatch Pet：用一张照片生成专属宠物 场景图](../assets/recipes/hatch-pet-photo.svg)

- 入口：[Codex × Hatch Pet：用一张照片生成专属宠物](hatch-pet-photo.md)

### 16 Codex × 安卓手机：扫码连接，远程操控
